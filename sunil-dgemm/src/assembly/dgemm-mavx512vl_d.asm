...
dgemm-mavx512vl:     file format elf64-x86-64
...
0000000000001ac0 <main._omp_fn.0>:
    ...
    1c7a:	62 53 7d 28 19 5c ff 	vextractf32x4 $0x1,%ymm11,0x10(%r15,%rdi,8)
    1c81:	01 01 
    1c83:	62 53 7d 28 19 54 fc 	vextractf32x4 $0x1,%ymm10,0x10(%r12,%rdi,8)
    1c8a:	01 01 
    1c8c:	c4 41 79 11 14 fc    	vmovupd %xmm10,(%r12,%rdi,8)
    1c92:	01 c8                	add    %ecx,%eax
    1c94:	62 53 7d 28 19 4c fd 	vextractf32x4 $0x1,%ymm9,0x10(%r13,%rdi,8)
    1c9b:	01 01 
...
0000000000001dd0 <main._omp_fn.1>:
    ...
    1e92:	62 f3 7d 28 19 d2 01 	vextractf32x4 $0x1,%ymm2,%xmm2
    ...
    1ec8:	62 f3 7d 28 19 d2 01 	vextractf32x4 $0x1,%ymm2,%xmm2
